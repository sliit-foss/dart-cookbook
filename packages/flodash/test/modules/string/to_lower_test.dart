...
void main() {
  ...
  test('should convert the string to lower case when it contains both lowercase and uppercase characters', () {
    String input = 'fooBar';
    String expected = 'foobar';
    String result = flodash.toLower(input);
    expect(result, expected);
  });
  test('should convert the string to lower case while preserving special characters', () {
